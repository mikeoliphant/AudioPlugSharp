...
namespace AudioPlugSharp.Asio
{
    ...
    internal class AsioInterop
    {
        ...
        public static AsioInterop GetASIODriverByName(String name)
        {
        ...
        /// <returns>an ASIODriver instance</returns>
        public static AsioInterop GetASIODriverByGuid(Guid guid)
        {
            AsioInterop driver = new AsioInterop();
